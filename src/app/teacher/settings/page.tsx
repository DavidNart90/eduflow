              ...
              <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
                <div className='lg:w-full'>
                  ...
                  <p className='text-slate-500 dark:text-slate-500 text-xs md:text-sm lg:text-center'>
                    Manage your account settings, security, and notification
                    preferences
                  </p>
                </div>
                <Badge
                ...
                <div className='flex items-center space-x-4 mb-6'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-slate-600 dark:text-slate-400 text-sm'>
                      Your profile details registered with the association
                    </p>
                  </div>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder='Miss Vida Opoukwun'
                      variant='filled'
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder='vida.opoukwun@education.gov.gh'
                      variant='filled'
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      placeholder='New Junction Municipal Education Office'
                      variant='filled'
                    />
                  </div>
                  <div>
              ...
              <CardContent className='p-2 md:p-6'>
                <div className='flex items-center space-x-4 mb-6'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-slate-600 dark:text-slate-400 text-sm'>
                      Choose which notifications you&aposd like to receive
                    </p>
                  </div>
                </div>
                  ...
                  <div className='flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-800/50 dark:to-blue-900/20 border border-slate-200/50 dark:border-slate-700/50'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-xs text-slate-500 dark:text-slate-400'>
                        Get notified when mobile money contributions are
                        processed
                      </p>
                    </div>
                  ...
                  <div className='flex items-start space-x-4'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-sm text-red-700 dark:text-red-400 mb-4 leading-relaxed'>
                        ...
                        sign out from all sessions on other devices. This will
                        force a re-login on all devices except the current one.
                      </p>
                      <Button
                        variant='error'
                        size='md'
